        ...
        <div class="col-md-9">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="userShow.jsp?id=<%=user.getId()%>" class="btn btn-primary">Show</a>
                        <a href="/userEdit?id=<%=user.getId()%>" class="btn btn-light">Edit</a>
                        <a href="userDelete.jsp?id=<%=user.getId()%>" class="btn btn-dark"
